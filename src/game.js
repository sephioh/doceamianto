window.onload = function() {
	...
	soundManager.onready(function() {
		...
		// soundManager ready to use; soundManager.createSound() etc. can now be called.
		...
		require([
			...
			Crafty.scene("loading", function(obj) { // obj -> { backgroundColor: 'color', soundToPlay: 'sound', ellipsisColor: 'color' }
				// clear scene
				sc = [], infc = [], sounds = {};
				...
				sounds = assets.createSound(gameContainer.scene);
